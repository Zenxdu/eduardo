...
exports.TextEditorHelper = exports.TextEditorHelperReturnType = void 0;
class TextEditorHelperReturnType {
    constructor(_pos, _mark) {
        this.pos = _pos;
        this.mark = _mark;
    }
}
exports.TextEditorHelperReturnType = TextEditorHelperReturnType;
