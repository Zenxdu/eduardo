...
exports.HtmlPreview = exports.SourceType = void 0;
...
class HtmlPreview {
    ...
    static sendPreviewCommand(previewUri, displayColumn) {
        if (textEditorHelper_1.TextEditorHelper.versionCompare(vscode_1.version, "1.23.0") < 0) {
    ...
    static sendPreviewCommand_1_23_0_BELOW(previewUri, displayColumn) {
        return vscode_1.commands.executeCommand(this.COMMAND_TOGGLE_PREVIEW, previewUri, displayColumn).then(() => { return; }, (reason) => {
            console.warn(reason);
            vscode_1.window.showErrorMessage(reason);
        });
    }
    static sendPreviewCommand_1_23_0(previewUri, displayColumn) {
        if (!vscode_1.window['createWebviewPanel']) {
            return Promise.resolve();
        }
        return vscode_1.workspace.openTextDocument(previewUri).then((doc) => {
            // Create and show a new webview
            const panel = vscode_1.window['createWebviewPanel'](previewUri.toString(), // Identifies the type of the webview. Used internally
            previewDocumentContentProvider_1.PreviewDocumentContentProvider.getPreviewTitle(doc.fileName), // Title of the panel displayed to the user
    ...
    static getExtensionPath_1_23_0_BELOW(...paths) {
        if (!!paths && paths.length > 0) {
            const p = vscode_1.Uri.parse(paths[0]);
    ...
    static getExtensionPath_1_23_0(...paths) {
        ...
        const onDiskPath = vscode_1.Uri.parse(onDiskPath_1_23_0_BELOW);
